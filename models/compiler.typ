  ...
  stack(
    rule-set(
      ...
      prooftree(rule(
        ...
        $compile(type(Gamma\,x:tau_1,mon(k,l,j,kappa_2,apply(e,x_1)),tau_2), e_1)$,
        $compile(type(Gamma,mon(k,l,j,kappa_1->kappa_2,e),tau_1 -> tau_2),lambda x: tau_1. e_1)$,
      )),
      prooftree(rule(
        name: [Compile-Dep],
        ...
        $compile(type(Gamma\,x:tau_1,mon(k,l,j,kappa_3,apply(e,x_1)),tau_2), e_1)$,
        $e_2 = {x_2\/x_kappa}e_1$,
        $#v(4em)compile(type(Gamma,mon(k,l,j,kappa_1->^d lambda x. kappa_2,e),tau_1 -> tau_2),lambda x: tau_1. e_2)$,
      )),
      prooftree(rule(
        name: [Compile-Tuple],
        $compile(type(Gamma,mon(k,l,j,kappa_1,v_1),tau), e_3)$,
        $compile(type(Gamma,mon(k,l,j,kappa_2,v_2),tau), e_4)$,
        $compile(type(Gamma,mon(k,l,j,tuple(kappa_1,kappa_2),tuple(v_1,v_2)),tau), tuple(e_3,e_4))$,
      )),
    ),
    v(2em),
    line(length: 100%),
