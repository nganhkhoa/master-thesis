...
\begin{figure}[htbp]
  ...
  \inferrule[Compile-If]
    { \cCompile{\cGamma}{e_1}{bool}{\Sigma_1}{e_1'} \\
      \cCompile{\cGamma}{e_2}{\tau}{\Sigma_2}{e_2'} \\
      \cCompile{\cGamma}{e_3}{\tau}{\Sigma_3}{e_3'} }
    { \cCompile{\cGamma}{\cIf{e_1}{e_2}{e_3}}{\tau}{\Sigma_1 \cup \Sigma_2 \cup \Sigma_3}{\eIf{e_1'}{e_2'}{e_3'}} }

  \inferrule[Compile-BinOp-Nat]
    { \cCompile{\cGamma}{e_1}{nat}{\Sigma_1}{e_1'} \\
      \cCompile{\cGamma}{e_2}{nat}{\Sigma_2}{e_2'} }
    { \cCompile{\cGamma}{e_1 \ \attrC{\oplus_{nat}} \ e_2}{nat}{\Sigma_1 \cup \Sigma_2}{e_1' \ \attrE{\oplus_{nat}} \ e_2'} }

  \inferrule[Compile-BinOp-Bool]
    { \cCompile{\cGamma}{e_1}{bool}{\Sigma_1}{e_1'} \\
      \cCompile{\cGamma}{e_2}{bool}{\Sigma_2}{e_2'} }
    { \cCompile{\cGamma}{e_1 \ \attrC{\oplus_{bool}} \ e_2}{bool}{\Sigma_1 \cup \Sigma_2}{e_1' \ \attrE{\oplus_{bool}} \ e_2'} }
  ...
  \inferrule[Compile-MonDep]
    { \attrC{y},\delta_y ∉ \cGamma \\
      ...
      \attrE{e''} = \attrE{e'}[\delta_y\coloneqq\attrE{e_y}]}
      {
